...
- terminal or IDE that supports console input/output.
...
Language: Java 
Packages & APIs: 
java.util.* → Data structures (ArrayList, TreeMap), user input via Scanner. java.time.LocalDate → Auto-captures the current date for study logs.
...
Attributes: LocalDate date, String subject, double duration, String description. Methods: Constructor, getters, toString().
